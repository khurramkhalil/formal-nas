...
typedef ap_fixed<18,8> cell_edges_0_op_0_table_t;
typedef ap_fixed<41,21> cell_edges_0_op_1_result_t;
typedef ap_fixed<16,6> cell_edges_0_op_1_weight_t;
typedef ap_fixed<16,6> cell_edges_0_op_1_bias_t;
...
typedef ap_fixed<41,21> cell_edges_3_op_1_result_t;
...
typedef ap_fixed<18,8> cell_edges_4_op_0_table_t;
typedef ap_fixed<41,21> cell_edges_4_op_1_result_t;
typedef ap_fixed<16,6> cell_edges_4_op_1_weight_t;
typedef ap_fixed<16,6> cell_edges_4_op_1_bias_t;
...
typedef ap_fixed<43,23> layer25_t;
